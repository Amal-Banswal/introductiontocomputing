...
def psum(list1, row):#This function takes current row element and row no. as  input and returns next row elements
    i1 = 0
    i2 = 1
    l = []
    ...
    l.append(1)
    return (l)
#Forming a function that uses recusion to print pascle's triangle
...
#making amal an object of student
amal=student("Amal",21104120)
amal.pfun()
del amal
...
emp_1=employees("Daksh",40000)
emp_2=employees("Abhay",50000)
emp_3=employees("Amal",60000)
#print employee detail
emp_1.pfun()
emp_2.pfun()
emp_3.pfun()
#Updating salary of Daksh to 70000
print("\nQue.5a")
emp_1.salary=70000
print("Daksh salary Updated to 70000")
emp_1.pfun()
#Deleting Abhay's data
print("\nQue.5b")
del emp_3
print("Employee Abhay's data has been removed.")
